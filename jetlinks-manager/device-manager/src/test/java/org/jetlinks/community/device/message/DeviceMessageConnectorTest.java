...
class DeviceMessageConnectorTest {
    ...
    @Test
    void createDeviceMessageTopic() {
    }

    @Test
    void testCreateDeviceMessageTopic() {
    }

    @Test
    void appendDeviceMessageTopic() {
    }
    ...
    @Test
    void handleChildrenDeviceMessage() {
    }

    @Test
    void handleChildrenDeviceMessageReply() {
    }

    @Test
    void testHandleChildrenDeviceMessageReply() {
    }
