package org.jetlinks.community.notify.manager.test.spring;
...
import org.jetlinks.community.notify.manager.test.utils.ContainerUtils;
...
//        elasticSearch.start();
        ...
        System.setProperty("spring.redis.serializer","fst");//使用fst序列化
